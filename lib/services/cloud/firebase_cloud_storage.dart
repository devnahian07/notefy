...
import 'package:notefy/services/cloud/cloud_storage_constants.dart';
import 'package:notefy/services/cloud/cloud_storage_exceptions.dart';
...
class FirebaseCloudStorage {
  ...
  Future<void> updateNote({required String documentId, required String text}) async {
    try{
      ...
      throw CouldNotUpdaetNoteException();
    }
  }

  // to listen to all the changes around, we use snapshots
